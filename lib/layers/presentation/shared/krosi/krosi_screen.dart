...
// class KrosiScreen extends StatefulWidget {
//   const KrosiScreen({super.key});

//     @override
//   State<KrosiScreen> createState() => _KrosiScreenState();
// }

// class _KrosiScreenState extends State<KrosiScreen> {
//   @override
...
//                 children: [
//                 Image.asset(width: 80,'assets/перчатки.png'),
//                 Image.asset(width: 80,'assets/перчатки.png'),
//                 Image.asset(width: 80,'assets/перчатки.png'),
//                 Image.asset(width: 80,'assets/перчатки.png'),
//                 Image.asset(width: 80,'assets/перчатки.png'),
...
//                 crossAxisSpacing: 10,
//                 mainAxisSpacing: 10,
//                 children: [CardScreen(), CardScreen1(), CardScreen3()],
//               ),
//             ),
//        ]
//       ),
